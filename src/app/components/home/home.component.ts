...
const APP_CARDS: AppCard[] = [
	...
	{
		icon: 'assets/images/Proficiency_Type_Element_Pierce_Energy.gif',
		title: 'Critical vs Elemental Pierce',
		description:
			'Compare o dano entre builds focadas em Critical Hit e Elemental Pierce para otimizar sua hunt',
		route: '/critical-vs-elemental-pierce',
